      ...
      <div className="mx-auto flex max-w-[1680px] flex-col gap-5">
        <header className="flex flex-col gap-4 rounded-2xl border border-white/[0.09] bg-white/[0.025] px-4 py-3 shadow-[0_18px_60px_rgba(0,0,0,0.18)] backdrop-blur-xl sm:flex-row sm:items-center sm:justify-between sm:px-5">
          ...
          <div className="flex items-center gap-2">
            ...
            <button type="button" className="inline-flex items-center gap-2 rounded-lg bg-amber-300 px-3 py-2 text-xs font-semibold text-slate-950 transition hover:bg-amber-200"><Share2 className="size-3.5" /> Share</button>
          </div>
        </header>
