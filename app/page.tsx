  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#0a0d10] text-[#f4f0e8] selection:bg-[#e29a63] selection:text-[#17100c]">
      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between border-b border-white/10 px-5 py-5 lg:px-10">
        ...
        <Button asChild size="sm" className="h-10 rounded-xl bg-[#f4f0e8] px-5 text-[11px] font-semibold text-[#15181b] shadow-lg hover:bg-[#e29a63] focus-visible:ring-2 focus-visible:ring-[#e29a63] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0a0d10]"><Link href="/editor">Open canvas <ArrowUpRight data-icon="inline-end" /></Link></Button>
      </nav>
      ...
      <section className="relative mx-auto grid max-w-7xl gap-14 px-5 pb-24 pt-20 lg:grid-cols-[.9fr_1.1fr] lg:items-center lg:gap-16 lg:px-10 lg:pb-32 lg:pt-28">
        ...
        <div className="relative z-[1]"><p className="mb-7 flex items-center gap-3 text-[10px] font-semibold uppercase tracking-[0.3em] text-[#e29a63]"><span className="h-px w-10 bg-[#e29a63]" />A calmer place to make</p><h1 className="max-w-2xl text-[clamp(4.2rem,8.5vw,8.7rem)] font-semibold leading-[.82] tracking-[-.09em]">Make space<br /><span className="font-serif font-normal italic text-[#e29a63]">for the idea.</span></h1><p className="mt-9 max-w-md text-[15px] leading-7 text-white/55">A focused visual workspace for early thoughts, clear systems, and the satisfying moment when everything clicks.</p><div className="mt-9 flex flex-col gap-3 sm:flex-row"><Button asChild size="lg" className="h-13 rounded-xl bg-[#e29a63] px-7 text-[#1a120d] shadow-[0_14px_34px_rgba(226,154,99,.2)] hover:bg-[#f2b27b] focus-visible:ring-2 focus-visible:ring-[#f2b27b] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0a0d10]"><Link href="/editor">Start designing <ArrowRight data-icon="inline-end" /></Link></Button><Button asChild variant="outline" size="lg" className="h-13 rounded-xl border-white/15 bg-white/[0.035] px-6 text-white hover:border-white/30 hover:bg-white/[0.08] focus-visible:ring-2 focus-visible:ring-[#e29a63] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0a0d10]"><a href="#why">Explore the method</a></Button></div><div className="mt-10 flex flex-wrap gap-x-6 gap-y-3 text-[11px] text-white/42"><span className="flex items-center gap-2"><Check className="size-3 text-[#e29a63]" /> No setup ceremony</span><span className="flex items-center gap-2"><Check className="size-3 text-[#e29a63]" /> Built for iteration</span></div></div>
        <div className="relative z-[1]"><Preview /></div>
      </section>

      <section id="why" className="border-y border-black/10 bg-[#e9e4da] px-5 py-20 text-[#171b20] lg:px-10 lg:py-28"><div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[.72fr_1.28fr] lg:items-end"><p className="text-[10px] font-semibold uppercase tracking-[0.3em] text-black/45">The visual layer</p><div><h2 className="max-w-4xl text-4xl font-semibold leading-[.92] tracking-[-.065em] sm:text-6xl">Good ideas deserve a room that gets out of the way.</h2><p className="mt-7 max-w-xl text-base leading-7 text-black/55">No ceremony between you and the work. Compose with intention, test the edges, and save the frames worth returning to.</p></div></div></section>
