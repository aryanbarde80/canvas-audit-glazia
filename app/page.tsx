  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#0b0d0f] text-[#f3f0e8] selection:bg-[#f0a15f] selection:text-[#16100c]">
      <nav className="relative z-10 mx-auto flex max-w-7xl items-center justify-between border-b border-white/10 px-5 py-5 lg:px-10">
        ...
        <Button asChild size="sm" className="h-10 rounded-full border border-white/10 bg-[#f3f0e8] px-5 text-[11px] font-semibold tracking-wide text-[#111315] shadow-[0_8px_24px_rgba(0,0,0,.2)] hover:-translate-y-0.5 hover:bg-[#f0a15f] hover:shadow-[0_12px_30px_rgba(240,161,95,.2)] focus-visible:ring-2 focus-visible:ring-[#f0a15f] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0b0d0f]"><Link href="/editor">Open canvas <ArrowUpRight data-icon="inline-end" /></Link></Button>
      </nav>
      ...
      <section className="relative mx-auto grid max-w-7xl gap-14 px-5 pb-20 pt-16 lg:grid-cols-[.92fr_1.08fr] lg:items-center lg:gap-10 lg:px-10 lg:pb-28 lg:pt-24">
        ...
        <div className="relative z-[1]">
          ...
          <div className="mt-8 flex flex-wrap gap-3"><Button asChild size="lg" className="h-12 rounded-full border border-[#ffc188]/40 bg-[#f0a15f] px-7 text-[#1a120d] shadow-[0_12px_34px_rgba(240,161,95,.18)] hover:-translate-y-0.5 hover:bg-[#ffc188] hover:shadow-[0_16px_40px_rgba(240,161,95,.28)] focus-visible:ring-2 focus-visible:ring-[#ffc188] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0b0d0f]"><Link href="/editor">Start designing <ArrowRight data-icon="inline-end" /></Link></Button><Button asChild variant="outline" size="lg" className="h-12 rounded-full border-white/20 bg-white/[0.04] px-6 text-white shadow-[0_8px_24px_rgba(0,0,0,.16)] hover:-translate-y-0.5 hover:border-white/35 hover:bg-white/10 focus-visible:ring-2 focus-visible:ring-[#f0a15f] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0b0d0f]"><a href="#manifesto"><Play data-icon="inline-start" /> See the approach</a></Button></div>
      ...
      <section className="mx-4 mb-5 overflow-hidden rounded-3xl bg-[#f0a15f] px-5 py-16 text-[#1c130e] sm:mx-6 sm:px-12 lg:mx-10 lg:px-20 lg:py-20"><div className="flex flex-col justify-between gap-8 md:flex-row md:items-end"><div><p className="mb-5 text-[10px] uppercase tracking-[0.3em] text-black/55">Begin anywhere</p><h2 className="max-w-2xl text-4xl font-semibold leading-[.9] tracking-[-.06em] sm:text-6xl">Your next clear thought is closer than it looks.</h2></div><Button asChild size="lg" className="h-12 w-fit rounded-full border border-black/10 bg-[#151719] px-7 text-[#f3f0e8] shadow-[0_12px_28px_rgba(28,19,14,.16)] hover:-translate-y-0.5 hover:bg-[#2c3033] hover:shadow-[0_16px_34px_rgba(28,19,14,.24)] focus-visible:ring-2 focus-visible:ring-[#151719] focus-visible:ring-offset-2 focus-visible:ring-offset-[#f0a15f]"><Link href="/editor">Enter canvas <ArrowUpRight data-icon="inline-end" /></Link></Button></div></section>
